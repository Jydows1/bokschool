...
const botKnowledge = [
    ...
    { 
        ...
        answer: "🗓 Тренировки проходят:<br>— Вт, Чт: 20:00 (Взрослые)<br>— Вт, Чт: 17:00 (Дети)<br>— Сб: 13:00 (Общая)<br><br>На какое время хотите записаться?", 
        chips: ['Записаться на 20:00', 'Записаться на 17:00', '🔙 В главное меню'] 
    },
    {
    ...
    {
        keywords: ['17:00', '17.00'],
        answer: "Отлично! 👍<br>Ждем вас к <b>17:00</b> на детскую тренировку.<br>Приходите за 15 минут до начала. Не забудьте форму! 🥊",
        chips: ['📍 Где зал?', '🎒 Что взять?', '🔙 В главное меню']
    },
    { 
    ...
    { 
        ...
        chips: ['Записаться на 20:00', 'Записаться на 17:00']
    },
    { 
